      ...
      <div className="page" style={{background:"url(/img/p3.jpg)",backgroundSize:"cover",backgroundAttachment:"center"}}>
        ...
        <div className="ab-skill shadow">
          ...
          <h1 className="sec-title">ความถนัดทางด้านภาษาคอมพิวเตอร์</h1>
            ...
            <Progress width="75%" bg="#e67e22"  title="C"/>
            ...
            <Progress width="85%" bg="#8bf6ff" title="ReactNative"/>
            <Progress width="80%" bg="#8e44ad" title="Bootstrap"/>
            <Progress width="80%" bg="#ffeb3b" title="Jquery"/>
            <Progress width="65%" bg="#001064" title="Nextjs & Gatsby"/>
            <Progress width="60%" bg="#2e7d32" title="Django"/>
            <Progress width="55%" bg="#e74c3c" title="Vuejs & Angularjs"/>
            </div>
        </div>
